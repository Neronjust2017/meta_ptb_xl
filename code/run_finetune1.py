...
from configs.finetune_configs import *
...
def main(args):
    ...
    name = 'finetune_inception1d_{}_{}_{}_{}'.format(args.task, args.corruption_type, args.corruption_prob, args.seed)
    experiments = [
        (name, args.task)
    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--corruption_prob', type=float, default=0.1, help='label noise')
